    ...
    public void execute(MinecraftServer server, ICommandSender icommandsender, String[] astring) throws CommandException
    {
        ...
        else
        {
            try
            {
                ...
                if (tp != null)
                {
                    AS_BattleTowersCore.LOGGER.log(Level.INFO, icommandsender.getName() + ": Battletower regenerated: " + tp.toString());
                ...
                {
                    AS_BattleTowersCore.LOGGER.log(Level.INFO, icommandsender.getName() + ": no Battletower regenerated, no valid target");
                }
            }
            catch (Exception e)
            {
